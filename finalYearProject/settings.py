...
SECRET_KEY = "django-insecure-8m6c_^e1vy=%j(l2_0=!e==&c_1dopeh6&y-dzx2do9v)$j6rg"
...
LOGIN_REDIRECT_URL = "/reserve/" #/here we enter the url where we want to redirect after login
